...
if (!isset($url) || strlen($url)<5 ){
  ...
  echo "<html><body><h1>CutyCapt<br>Usage: link.php?url=...&x=..&y=..&w=..&h=..</h1>";
  echo "<h2>Examples</h2>";
  echo "<a href=\"link.php?url=http://tobata.asia/\" >tobata.asia</a><br>";
  echo "<a href=\"link.php?url=http://tobata.asia/&x=100&y=100&w=200&h=150\" >tobata.asia +100+100_200x150</a><br>";
  echo "<a href=\"link.php?url=http://tobata.asia/&x=300&y=100&w=200&h=150\" >tobata.asia +300+100_200x150</a><br>";
...
echo "https://cutycapt.tobata.asia/{$fname}";
